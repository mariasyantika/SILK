    ...
    <link href="{{ asset('css/custom.css') }}" rel="stylesheet">
        ...
        <script type="text/javascript" language="javascript">
            ...
            function save(){
                ...
                // send it out
                let xhr = new XMLHttpRequest();
                xhr.open("POST", 'http://localhost/silk2024-slim-main/public/rawatjalan');
                xhr.send(formData);

                xhr.onload = () => alert(xhr.response);
            }
            
            window.onload = insert_rawat_jalan;
            </script>
    </head>
    <body class="antialiased">
        <div class="relative">
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    <div class="flex justify-center">
                        <img src="https://th.bing.com/th/id/OIG2.07cbahWmRCJCncI129Ew?pid=ImgGn" width="50" height="50" alt="logo">
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/daftarobat">Obat</a>
                            </li>
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-black bolder" >Form Rawat Jalan</h2>
                </div>

                <div class="mt-16">
                        <div>
                            @csrf
                            <form action="/rawatjalan/save" method="POST">
                                <div class="mb-3">
                                    <label for="id" class="form-label">ID</label>
                                    <input type="text" class="form-control" id="id" placeholder="Masukkan ID tindakan">
                                </div>
                                <div class="mb-3">
                                    <label for="tindakan" class="form-label">Tindakan</label>
                                    <textarea class="form-control" id="keluhan" rows="3" placeholder="Isi tindakan yang dilakukan"></textarea>
                                </div>
                                <div class="mb-3">
                                    <label>Pilih Obat</label>
                                    <select name="sku" class="form-control">
                                        <option value="0">Pilih SKU</option>
                                        <option value="23456789" >23456789</option>
                                        <option value="12345678">12345678</option>
                                        <option value="01234567">01234567</option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    <label for="label_catatan" class="form-label">Label Catatan Obat</label>
                                    <textarea class="form-control" id="keluhan" rows="3" placeholder="Isi catatan *bila perlu"></textarea>
                                </div>
