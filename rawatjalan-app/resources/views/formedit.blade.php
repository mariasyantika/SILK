    ...
    <body class="antialiased">
        <div class="relative">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-black bolder" >Form Pasien</h2>
                </div>

                <div class="mt-16">
                        <div>
                            <table class="table table-striped table-hover" id="outputTabel">
                                    <thead>
                                        <th scope="col">ID</th>
                                        ...
                                        <th scope="col">Kontak Kel</th>
                                        <th scope="col">No Hp kontak Kel</th>
                                        <th scope="col">Alamat kontak Kel</th>
                                    </thead>
                                    <tbody>
                                    </tbody>
                                </table>
                            @csrf
                            <form action="/formedit/{id}" method="POST">        
