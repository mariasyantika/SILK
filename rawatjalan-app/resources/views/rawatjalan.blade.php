    ...
    <div class="relative">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <img src="https://th.bing.com/th/id/OIG2.07cbahWmRCJCncI129Ew?pid=ImgGn" width="100" height="100"
                    alt="">
            </div>
            ...
            <div class="mt-16">
                <div
                    ...
                    <div>
                        {{-- Logo Data Rawat Jalan --}}
                        <div
                            class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-bar-chart-steps w-7 h-7 stroke-red-500" viewBox="0 0 16 16">
                                <path
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Data Rawat Jalan</h2>
